...
const ProfileCard = ({ user }) => {
  return (
    <>
      ...
      <p>Level: {user.trainerLevel}</p>
      <p>Trainer Code: {user.trainerCode}</p>
      <SocialContainer>
        <svg
      ...
      <br />
      <p>
        coords: {user.locLatitude} {user.locLongtitude}
      </p>
      <br />
      <div>
        trade lists:
        ...
        {user.followers.map((follower) => (
          <FriendCell key={follower.follower.userName}>
            ...
            <Link
              ...
              prefetch={false}
            >
              <a>{follower.follower.userName}</a>
            </Link>
          </FriendCell>
        ))}
      </div>
      ...
      <div>
        ...
        {user.following.map((following) => (
          <div key={following.user.userName}>
            <div>
              {following.user.trainerTeam}
